...
export interface IServiceTaxonomiesDetailsFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class ServiceTaxonomiesDetailsFieldsValue extends React.Component<
  IServiceTaxonomiesDetailsFieldsValueProps,
  IServiceTaxonomiesDetailsFieldsValueState
> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { serviceTaxonomiesDetailsFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ serviceTaxonomiesDetailsFieldsValue }: IRootState) => ({
  ...
  totalItems: serviceTaxonomiesDetailsFieldsValue.totalItems
});
