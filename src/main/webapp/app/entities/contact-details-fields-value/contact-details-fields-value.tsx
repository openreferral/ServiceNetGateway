...
export interface IContactDetailsFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class ContactDetailsFieldsValue extends React.Component<IContactDetailsFieldsValueProps, IContactDetailsFieldsValueState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { contactDetailsFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ contactDetailsFieldsValue }: IRootState) => ({
  ...
  totalItems: contactDetailsFieldsValue.totalItems
});
