...
export interface IServiceAreaState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class ServiceArea extends React.Component<IServiceAreaProps, IServiceAreaState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { serviceAreaList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ serviceArea }: IRootState) => ({
  ...
  totalItems: serviceArea.totalItems
});
