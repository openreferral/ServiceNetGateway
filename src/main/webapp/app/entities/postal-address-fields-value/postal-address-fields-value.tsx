...
export interface IPostalAddressFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class PostalAddressFieldsValue extends React.Component<IPostalAddressFieldsValueProps, IPostalAddressFieldsValueState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { postalAddressFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ postalAddressFieldsValue }: IRootState) => ({
  ...
  totalItems: postalAddressFieldsValue.totalItems
});
