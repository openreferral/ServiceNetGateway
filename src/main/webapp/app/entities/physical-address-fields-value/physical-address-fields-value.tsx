...
export interface IPhysicalAddressFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class PhysicalAddressFieldsValue extends React.Component<IPhysicalAddressFieldsValueProps, IPhysicalAddressFieldsValueState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { physicalAddressFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ physicalAddressFieldsValue }: IRootState) => ({
  ...
  totalItems: physicalAddressFieldsValue.totalItems
});
