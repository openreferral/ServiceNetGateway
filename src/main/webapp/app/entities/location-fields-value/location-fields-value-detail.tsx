    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/location-fields-value" color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/location-fields-value/${locationFieldsValueEntity.id}/edit`} color="primary">
