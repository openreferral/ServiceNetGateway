...
export interface ILocationFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class LocationFieldsValue extends React.Component<ILocationFieldsValueProps, ILocationFieldsValueState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { locationFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ locationFieldsValue }: IRootState) => ({
  ...
  totalItems: locationFieldsValue.totalItems
});
