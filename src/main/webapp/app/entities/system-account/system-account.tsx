...
import { Translate, ICrudGetAllAction, IPaginationBaseState, getSortState, JhiPagination, getPaginationItemsNumber } from 'react-jhipster';
...
export interface ISystemAccountState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class SystemAccount extends React.Component<ISystemAccountProps, ISystemAccountState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { systemAccountList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ systemAccount }: IRootState) => ({
  ...
  totalItems: systemAccount.totalItems
});
