    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/service-fields-value" color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/service-fields-value/${serviceFieldsValueEntity.id}/edit`} color="primary">
