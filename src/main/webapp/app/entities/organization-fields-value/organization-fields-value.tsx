...
export interface IOrganizationFieldsValueState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class OrganizationFieldsValue extends React.Component<IOrganizationFieldsValueProps, IOrganizationFieldsValueState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { organizationFieldsValueList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ organizationFieldsValue }: IRootState) => ({
  ...
  totalItems: organizationFieldsValue.totalItems
});
